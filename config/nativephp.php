...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.torythurlow.checkpoint'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'A native gaming companion with persistent game workspaces'),
